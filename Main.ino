...
char *organ_names[] = {
    "Niederzwehren", // Beispielname für Orgel 1
    "Silbermann", // Beispielname für Orgel 2
    "St. Clement",  // Beispielname für Orgel 3
    "Wildervank"  // Beispielname für Orgel 4
};

// Orgel 1
char *buttonText[] = {
    "Prinzipal 8.", "Hohlfloete 8.", "Oktave 4.", "Blockfloete 4.", "Oktave 2.", "Flageolett 2.", "Cornett 4f",
    "Mixtur 4-6f", "Trompete 8.", " ", " ", " ", " ", "I-II",

    "Gedackt 8.", "Gambe 8.", "Principal 4.", "Rohrfloete 4.", "Oktave 2.", "Nasat 1 1/3",
    "Sesquialtera 2f", "Scharff 3-4f", "Cromorne 8.", " ", " ",  " ", " ", "Tremulant",

    "Subbass 16.", "Principalbass 8.", "Gemhorn 8.", "Octavbass 4.", "Posaune 16.", "Trompete 8.",
    " ", "I-P", "II-P", " ", " ", " ", " ", "Aufnahme"
};
...
char *buttonText1[] = {
   "Principal 8", "Quintadena 8", "Rohrfloete 8", "Octava 4", "Spitzfloethe 4", "Quinta 3", "Octava 2",
    ...
    "Subbass 16.", "Octavbass 8", "Posaune 16", " ", "Koppel P/1", "Koppel P/II",
    " ", " ", " ", " ", " ", " ", " ", "Aufnahme"
};

// Orgel 3
char *buttonText2[] = {
    "Principal 8.", "Salicet 8.", "Floete 8.", "Flaut major 8.", "Principal 4.", "Flauto 4.", "Quinte 2 2/3",
    " ", " ", " ", " ", " ", " ", " ",

    " ", " ", " ", " ", " ", " ",
    " ", " ", " ", "", " ",  " ", " ", " ",

    "Subbass 16.", "Principal 8.", "Violoncello 8.", " ", " ", " ",
    " ", "I-P", " ", " ", " ", " ", " ", "Aufnahme"
};

// Orgel 4
char *buttonText3[] = {
    "Bourdon 16.", "Principal 8.", "Doppelfloete 8.", "Dolce 8.", "Oktave 4.", "Flute 4.", "Oktave 2",
    "Mixtur", "Cornet IV", "Trompete 8.", "I Super", "I+II", "I+II Sub", "I+II Super",

    "Geig. Prinz. 8.", "Synthemato. 8.", "Lieb. Gedeckt 8.", "Viola 8.", "Salicet 4.", "Flute Harm. 4.",
    "Quinte 2 2/3", "Gemshorn 2", "Cornett IV", "Scharff", "Echo Tromp. 8.",  "II Sub", "II Super", "Tremulant",

    "Contrabass 16.", "Subbass 16.", "Gedecktbass 16.", "Oktavbass 8.", "Violonbass 8.", "Gedeckt 8.",
    "Oktave 2.", "Posaune 16.", "Fagottbass 32.", "Ped + I", "Ped + I Super", "Ped + II", " ", "Aufnahme"
};
...
static void setup_button_event_handler(lv_event_t * e) {
    ...
    if (event_code == LV_EVENT_CLICKED) { // Reagiere auf Klick-Event für Setup Buttons
        ...
        if (label) {
            ...
            if (strcmp(current_organ_name, organ_names[0]) == 0) {
                Serial.println("Orgel 0");
            } else if (strcmp(current_organ_name, organ_names[1]) == 0) {
                Serial.println("Orgel 1");
            } else if (strcmp(current_organ_name, organ_names[2]) == 0) {
                Serial.println("Orgel 2");
            } else if (strcmp(current_organ_name, organ_names[3]) == 0) {
                Serial.println("Orgel 3");
            }
            ...
            if (strcmp(lv_label_get_text(label), organ_names[0]) == 0) {
                sendNoteON(1);
                updateRegisterButtonLabels(buttonText); // Übergib organ1_buttonText für "Organ 1"
            } else if (strcmp(lv_label_get_text(label), organ_names[1]) == 0) {
                sendNoteON(2);
                updateRegisterButtonLabels(buttonText1); // Übergib organ2_buttonText für "Organ 2"
            } else if (strcmp(lv_label_get_text(label), organ_names[2]) == 0) {
                sendNoteON(3);
                updateRegisterButtonLabels(buttonText2); // Übergib organ3_buttonText für "Organ 3"
            } else if (strcmp(lv_label_get_text(label), organ_names[3]) == 0) {
                sendNoteON(4);
                updateRegisterButtonLabels(buttonText3); // Übergib organ3_buttonText für "Organ 3"
            }
